    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-indigo-900 flex justify-center items-center p-4 relative overflow-hidden font-mono">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <div className="text-sm text-cyan-400/70">Authenticate to continue</div>
        </div>
        ...
        <div className="text-center mt-6 text-gray-300">
          <p className="mb-2">
            NEW USER? 
            <a href="/register" className="text-cyan-400 font-bold hover:text-purple-400 transition-colors duration-300 ml-2">
              REGISTER
            </a>
          </p>
          <p>
            <a href="#" className="text-purple-400 font-bold hover:text-pink-400 transition-colors duration-300">
